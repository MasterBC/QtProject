...
::google::protobuf::Metadata file_level_metadata_baccarat_2eproto[6];
...
const ::google::protobuf::uint32 TableStruct_baccarat_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::go::GameBaccaratOver, acquire_),
};
...
::google::protobuf::internal::AssignDescriptorsTable assign_descriptors_table_baccarat_2eproto = {
  ...
  file_level_metadata_baccarat_2eproto, 6, file_level_enum_descriptors_baccarat_2eproto, file_level_service_descriptors_baccarat_2eproto,
};
...
const int GameBaccaratOver::kAcquireFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
